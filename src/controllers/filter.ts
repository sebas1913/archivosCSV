import { DataTable } from "../models/models"; // Importa el tipo DataTable desde los modelos

export function filterData(arrayTable: DataTable, searchTerm: string): DataTable {
    if (!searchTerm) return arrayTable; // Si no hay término de búsqueda, devuelve la tabla sin cambios
